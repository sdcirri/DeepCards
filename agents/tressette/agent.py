...
from environments.tressette_env import env as env_factory
...
def _one_episode(a1: Cards2PAgent, a2: Cards2PAgent, render_mode: str) -> tuple[int, int]:
    ...
    # Tressette scores are stored in thirds; report whole points.
...
def challenge(
    ...
    if render_mode == 'human':
        return run_human_challenge(
            ...
            kind='tressette',
            score_of=lambda raw: (raw.scores['p1'] // 3, raw.scores['p2'] // 3),
        )
